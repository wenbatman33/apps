...
const Sound = {
  ...
  // 主要事件採 Kenney casino-audio（CC0）多變體取樣
  FILES: {
    shuffle: ['kenney/card-shuffle.mp3', 'shuffle1.mp3', 'shuffle2.mp3'],
    deal: ['kenney/card-slide-1.mp3', 'kenney/card-slide-2.mp3', 'kenney/card-slide-3.mp3', 'kenney/card-slide-4.mp3', 'kenney/card-slide-5.mp3', 'kenney/card-slide-6.mp3', 'kenney/card-slide-7.mp3', 'kenney/card-slide-8.mp3'],
    flip: ['kenney/card-place-1.mp3', 'kenney/card-place-2.mp3', 'kenney/card-place-3.mp3', 'kenney/card-place-4.mp3'],
    fan: ['kenney/card-fan-1.mp3', 'kenney/card-fan-2.mp3'],
    foldCard: ['kenney/card-shove-1.mp3', 'kenney/card-shove-2.mp3', 'kenney/card-shove-3.mp3', 'kenney/card-shove-4.mp3'],
    chip: ['kenney/chip-lay-1.mp3', 'kenney/chip-lay-2.mp3', 'kenney/chip-lay-3.mp3'],
    stack: ['kenney/chips-stack-1.mp3', 'kenney/chips-stack-2.mp3', 'kenney/chips-stack-3.mp3', 'kenney/chips-stack-4.mp3', 'kenney/chips-stack-5.mp3', 'kenney/chips-stack-6.mp3'],
    push: ['kenney/chips-handle-1.mp3', 'kenney/chips-handle-2.mp3', 'kenney/chips-handle-3.mp3', 'kenney/chips-handle-4.mp3', 'kenney/chips-handle-5.mp3', 'kenney/chips-handle-6.mp3'],
    collide: ['kenney/chips-collide-1.mp3', 'kenney/chips-collide-2.mp3', 'kenney/chips-collide-3.mp3', 'kenney/chips-collide-4.mp3'],
    tap: ['button_tap.wav'],
  ...
  fold() { this._play('foldCard', { vol: 0.65, rate: this._vary(1) }) || this._tone(220, 0.12, 'sine', 0.1); },
  fan() { this._play('fan', { vol: 0.85, rate: this._vary(1) }) || this._tone(990, 0.08, 'triangle', 0.08); },
  collide() { this._play('collide', { vol: 0.7, rate: this._vary(1, 0.1) }) || this._tone(1320, 0.05, 'square', 0.05); },
