...
import { createGeneratedAssets } from '../assets/createGeneratedAssets.js';
...
export class PreloadScene extends Phaser.Scene {
    ...
    preload() {
        ...
        for (let index = 0; index < 8; index += 1) {
            ...
            this.load.image(`player-death-explosion-${index}`, `assets/images/generated/vfx/player-death-explosion-${index}.png`);
        }
    }
    create() {
