...
DATA = [
    ...
    ("dyn/11", None, "bottom", {"x":0.7956, "y":1.0000, "w":0.0901, "h":0.0460}),
    # 飛靶 5 個位置（位置1..5 = 0..4），column 5 外推
    ("plate/send", None, "bottom", {"x":0.9300, "y":0.0811, "w":0.0495, "h":0.0742}),
    ...
    ("plate/5", None, "bottom", {"x":0.1500, "y":0.1670, "w":0.0495, "h":0.0742}),
    # 酒瓶
    ("bottle/send", None, "bottom", {"x":0.9300, "y":0.3213, "w":0.0267, "h":0.0957}),
    ...
    ("bottle/5", None, "bottom", {"x":0.1700, "y":0.3369, "w":0.0267, "h":0.0957}),
    # 酒杯
    ("cup/send", None, "bottom", {"x":0.9300, "y":0.3379, "w":0.0293, "h":0.0566}),
    ...
    ("cup/5", None, "bottom", {"x":0.1750, "y":0.3535, "w":0.0293, "h":0.0566}),
    # 夫妻
