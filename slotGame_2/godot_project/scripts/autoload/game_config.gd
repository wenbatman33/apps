...
const PAYLINES: Array = [
	...
	[1, 1, 0, 1, 1],  # Line 6:  中中上中中
	[1, 1, 2, 1, 1],  # Line 7:  中中下中中
	[0, 0, 1, 2, 2],  # Line 8:  上上中下下
	[2, 2, 1, 0, 0],  # Line 9:  下下中上上
	[1, 0, 0, 0, 1],  # Line 10: 中上上上中
	[1, 2, 2, 2, 1],  # Line 11: 中下下下中
	[0, 1, 1, 1, 0],  # Line 12: 上中中中上
	[2, 1, 1, 1, 2],  # Line 13: 下中中中下
	[0, 0, 2, 0, 0],  # Line 14: 上上下上上
	[2, 2, 0, 2, 2],  # Line 15: 下下上下下
	[1, 0, 1, 0, 1],  # Line 16: 中上中上中
	[1, 2, 1, 2, 1],  # Line 17: 中下中下中
	[0, 1, 0, 1, 0],  # Line 18: 上中上中上
	[2, 1, 2, 1, 2],  # Line 19: 下中下中下
	[0, 2, 0, 2, 0],  # Line 20: 上下上下上
]
